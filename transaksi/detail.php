...
$sql = "SELECT * FROM peminjaman p INNER JOIN detail_peminjaman dp ON p.id_pinjam
=dp.id_pinjam INNER JOIN buku b ON b.id_buku=dp.id_buku where p.id_pinjam='$id_pinjam'";
