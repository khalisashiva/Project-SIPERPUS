...
$sql = "SELECT * FROM peminjaman INNER JOIN anggota ON peminjaman.id_anggota=anggota.id_anggota INNER JOIN detail_peminjaman dp USING(id_pinjam) INNER JOIN petugas ON peminjaman.id_petugas=petugas.id_petugas where  peminjaman.tgl_pinjam='$waktu' or peminjaman.tgl_jatuh_tempo='$waktu' ORDER BY peminjaman.tgl_pinjam ";
}else{
